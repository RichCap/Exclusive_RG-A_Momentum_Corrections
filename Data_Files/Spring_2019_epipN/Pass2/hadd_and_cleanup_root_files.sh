...
DIRECTORY="/w/hallb-scshelf2102/clas12/richcap/Exclusive_RG-A_Momentum_Corrections/Data_Files/Spring_2019_epipN/Pass2/" # Adjust the directory path as needed
FILE_PATTERN="Single_Pion_Channel_epipX_Inbending_With_Dp_${VARIABLE_PART}_File"
