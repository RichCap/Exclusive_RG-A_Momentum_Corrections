#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=double_pion_out_pro_mom_cor_eppipX_GitHub_F2_DP_8_14_2022
...
srun python ../../File_Creation_Final_Momentum_Corrections_Github.py Out DP ${FILES[$SLURM_ARRAY_TASK_ID]}
