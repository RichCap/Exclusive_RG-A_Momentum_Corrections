#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=double_pion_in_pro_mom_cor_eppipX_VFinal_SP_V8_DP_6_22_2022
...
srun python ../../File_Creation_All_Corrections_Simplified_No_Loop_Finished_SP.py In DP ${FILES[$SLURM_ARRAY_TASK_ID]}
