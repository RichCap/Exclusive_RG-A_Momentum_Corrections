...
DIRECTORY="/w/hallb-scshelf2102/clas12/richcap/Exclusive_RG-A_Momentum_Corrections/Data_Files/Only_Electron_Channel/Pass2/Outbending/" # Adjust the directory path as needed
FILE_PATTERN="Electron_Only_eX_Outbending_With_Dp_${VARIABLE_PART}_File"
