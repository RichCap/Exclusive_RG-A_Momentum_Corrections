...
DIRECTORY="/w/hallb-scshelf2102/clas12/richcap/Exclusive_RG-A_Momentum_Corrections/Data_Files/Only_Electron_Channel/Inbending/Spring2019_Pass2/" # Adjust the directory path as needed
FILE_PATTERN="Electron_Only_eX_Inbending_With_Dp_${VARIABLE_PART}_File"
INPUT_FILES="${FILE_PATTERN}_6*root"
